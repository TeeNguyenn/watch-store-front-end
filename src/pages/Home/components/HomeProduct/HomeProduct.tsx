...
const HomeProduct = () => {
    ...
    return (
        ...
        >
            <div className={cx('home-product__media-wrapper')}>
            ...
            <div className={cx('home-product__info-wrapper')}>
                <div className={cx('home-product__info')}>
                    ...
                    <p className={cx('home-product__sub-title')}>
                        Our Smart wristwatch will help you stay on top of trends
                        and improve your quality of life. This next-generation
                        wearable redefines ease and connectivity like never
                        before thanks to its innovative design and
